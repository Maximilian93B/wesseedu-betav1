    ...
    >
      ...
      >
        ...
        <div className="max-w-3xl mx-auto mb-10 sm:mb-12 text-center">
          ...
          >
            <LineChart size={16} className="text-blue-200 mr-2" />
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8">
            ...
            <div className="bg-white rounded-xl overflow-hidden border border-white/20 group hover:shadow-lg transition-all duration-300">
              <div className="relative h-36 sm:h-40 md:h-48 overflow-hidden">
                <div className="absolute top-4 left-4 z-20">
                  <span className="inline-flex items-center px-3 py-1 text-sm font-medium rounded-full text-white bg-blue-600/90 backdrop-blur-sm">
                    FEATURED
                  </span>
                </div>
                <Image 
              ...
              <div className="p-5 sm:p-6">
                ...
                <div className="flex justify-between items-center pt-1">
                  ...
                  <span className="text-lg font-medium text-blue-600 whitespace-nowrap">Preview Available</span>
                </div>
              </div>
            </div>
              ...
              {[
                {
                  ...
                  icon: <TrendingUp size={14} className="mr-2 flex-shrink-0" />,
                ...
                },
                {
                  ...
                  icon: <BookMarked size={14} className="mr-2 flex-shrink-0" />,
                ...
                <div key={idx} className="bg-white rounded-xl shadow-sm overflow-hidden border border-white/20 hover:shadow-lg transition-all duration-300 flex flex-col">
                  ...
                  <div className="p-4 sm:p-5 flex flex-col flex-grow">
                    <h4 className="font-bold text-base sm:text-lg mb-2 line-clamp-1">{article.title}</h4>
                    <p className="text-sm sm:text-base text-slate-600 mb-3 line-clamp-2 flex-grow">{article.desc}</p>
          ...
          <motion.div variants={itemVariants}>
            ...
            <div className="rounded-xl p-6 sm:p-7 shadow-md border border-white/30 relative overflow-hidden bg-gradient-to-br from-blue-600/20 to-blue-800/40 backdrop-blur-md">
              ...
              <h3 className="text-2xl sm:text-3xl font-extrabold text-white tracking-tight drop-shadow-[0_1px_2px_rgba(0,0,0,0.15)] mb-4 break-words">Unlock Premium Content</h3>
              <p className="text-base sm:text-lg text-white/90 font-medium mb-5 sm:mb-6 leading-relaxed">
              ...
              <div className="mb-6 sm:mb-7">
                <h4 className="text-lg sm:text-xl font-extrabold text-white tracking-tight drop-shadow-[0_1px_1px_rgba(0,0,0,0.1)] mb-4">Member Benefits:</h4>
                <ul className="space-y-3">
                  ...
                  {[
                    ...
                    <li key={idx} className="flex items-start">
                      ...
                      <span className="text-base sm:text-lg font-medium text-white leading-tight">{benefit}</span>
                    </li>
                  ))}
                </ul>
              </div>
              ...
              <div className="mb-7">
                ...
                >
                  <Link href="/auth/signup">
                    <span className="flex items-center text-base sm:text-lg font-bold justify-center tracking-wide">
                      Join WeSeedU
                ...
                <div className="flex flex-col space-y-4">
                  ...
                  <div className="flex items-center justify-between">
                    <div className="flex items-center space-x-4">
                      ...
                      <div>
                        <p className="text-white text-base font-semibold">Members</p>
                        <p className="text-white/70 text-sm">in our investing community</p>
                      </div>
                    </div>

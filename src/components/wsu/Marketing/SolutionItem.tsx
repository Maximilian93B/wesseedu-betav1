...
export const SolutionItem = ({ id, step, title, description, icon: Icon, solves, index }: SolutionItemProps) => {
  return (
    <motion.div
      id={`solution-${id}`}
    ...
    >
      <div className="relative">
        <div
          ...
          flex items-center justify-center relative overflow-hidden group-hover:border-teal-500/50 transition-all duration-300 shadow-[0_0_15px_rgba(139,92,246,0.15)] icon-container"
        >
          <div
      ...
      <div className="flex flex-col justify-center relative z-10">
        ...
        <div className="max-w-[180px] item-description">
          ...
          <p className="text-[10px] text-white/60 mt-1 italic bg-[#0A1A3B]/50 backdrop-blur-sm p-1 rounded">{solves}</p>
        </div>
      </div>
    </motion.div>
  );

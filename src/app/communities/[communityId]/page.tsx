  ...
  if (loading) {
    return (
      <main className="min-h-screen bg-white dark:bg-slate-950 relative">
        ...
        <div className="absolute top-10 left-1/4 w-96 h-96 bg-orange-100/20 dark:bg-orange-900/10 blur-[120px] rounded-full pointer-events-none" />
        <div className="absolute bottom-20 right-1/3 w-72 h-72 bg-blue-100/20 dark:bg-blue-900/10 blur-[100px] rounded-full pointer-events-none" />
        
        {/* Return to home button - fixed position */}
        <div className="fixed top-6 left-6 z-50">
          <button
            onClick={handleReturnHome}
            className="flex items-center gap-2 px-4 py-2 bg-white dark:bg-slate-900 hover:bg-slate-100 dark:hover:bg-slate-800 text-slate-700 dark:text-slate-200 rounded-md border border-slate-200 dark:border-slate-700 backdrop-blur-sm transition-colors shadow-sm"
          >
            <HomeIcon className="h-4 w-4 text-orange-500 dark:text-orange-400" />
            Return to Home
          </button>
        </div>
        ...
        <div className="container mx-auto px-4 pt-28 pb-20 relative z-10">
          <div className="flex justify-center py-16">
            <div className="w-14 h-14 border-2 border-t-orange-500 border-r-orange-400/40 border-b-orange-400/20 border-l-orange-400/60 rounded-full animate-spin"></div>
          </div>
        </div>
      </main>
    )
